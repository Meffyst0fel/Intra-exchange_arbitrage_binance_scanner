            ...
            for trade in profitable_trades[:]:
                ...
                if None not in order_books:
                    ...
                    if trade['profit'] <= 0:
                        ...
                        continue
                print(f"Вигідна угода триває: {symbols_set}, Поточна тривалість: {trade['current_duration']:.2f} секунд, Початковий прибуток: {initial_profit:.2f} USDT, Поточний прибуток: {trade['profit']:.2f} USDT")
        time.sleep(1)
...
# Запуск оновлення тривалості в окремому потоці
